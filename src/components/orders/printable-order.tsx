        ...
        <div className="print-only p-8 bg-white text-black font-sans">
          <div className="grid grid-cols-2 gap-8 mb-10">
            ...
            <div className="text-right">
              ...
              {order.createdBy && <p className="text-md"><span className="font-semibold">Sales Rep:</span> {getEmployeeNameFromEmail(order.createdBy)}</p>}
            </div>
          </div>
          ...
          <div className="mb-8 p-4 border border-gray-300 rounded-md bg-gray-50">
            ...
            <p className={customer?.companyName ? "text-sm text-gray-600" : "font-medium text-gray-800"}>
              {customer ? `${customer.firstName} ${customer.lastName}`.trim() : (order.customerName || 'N/A')}
            </p>
